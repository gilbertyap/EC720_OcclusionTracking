...
# python3 deep_sort_app.py --sequence_dir='../David3/img/' --detection_file='../EC720_OcclusionTracking/dets/img.npy' --min_confidence=0.9 --nn_budget=100 --output_file='../EC720_OcclusionTracking/deep_sort/ds_results.txt' --display=True
python3 deep_sort_app.py --sequence_dir='../Subway/img/' --detection_file='../EC720_OcclusionTracking/dets/img.npy' --min_confidence=0.9 --nn_budget=100 --output_file='../EC720_OcclusionTracking/deep_sort/ds_results.txt' --display=True
# python3 deep_sort_app.py --sequence_dir='../Human3/img/' --detection_file='../EC720_OcclusionTracking/dets/img.npy' --min_confidence=0.9 --nn_budget=100 --output_file='../EC720_OcclusionTracking/deep_sort/ds_results.txt' --display=True
# python3 deep_sort_app.py --sequence_dir='../Challenge1_SEQ1/person2' --detection_file='../EC720_OcclusionTracking/dets/person2.npy' --output_file='../EC720_OcclusionTracking/deep_sort/ds_results.txt' --display=False
