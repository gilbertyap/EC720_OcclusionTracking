...
# python3 gilberty_script_iraei.py --img_dir '/home/gilbert/Downloads/Human3/img/' --gt_path './human3_gt.txt' --sort_path '../EC720_OcclusionTracking/deep_sort/ds_results.txt'
